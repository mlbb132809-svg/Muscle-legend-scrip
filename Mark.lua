local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/EpicDeevv/Private-Scripts/refs/heads/main/th5j6j5j5j", true))()

local window = library:AddWindow("MARK PRIVATE SCRIPT", {
